        ...
        >
          ...
          <div className="p-4 sm:p-8 md:p-16 md:pt-8 flex flex-col justify-center items-center relative overflow-hidden">
            <div className="mb-8 z-20">
              ...
              <p className="pt-6">
                We're organising an exciting new improv festival to be held{" "}
                <strong>12 – 14 June 2020</strong> at the{" "}
                <a
                  href="https://spektakel.wien/"
                  className="font-bold hover:underline"
                >
                  Spektakel Theatre
                </a>{" "}
                in Vienna, Austria. There will be whole days filled with improv
                training, jam sessions and performances in both English and
                German...basically just a weekend-long impro-party!
              </p>
              <p className="pt-6">
                To stay informed please join our mailing list below or follow us
                on{" "}
                <a
                  className="underline hover:underline"
                  href="https://www.facebook.com/BLINK.Improfestival"
                >
                  Facebook
                </a>
                .
              ...
              <p className="pt-4 text-right text-gray-500">
                -- Christof, Hanni, Shawn, Florian, Coline and Ben
              </p>
            </div>
